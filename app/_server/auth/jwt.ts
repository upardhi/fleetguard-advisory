...
export async function signAccessToken(claims: Omit<JwtClaims, "iat" | "exp">): Promise<string> {
...
export async function signRefreshToken(sessionId: string, userId: string): Promise<string> {
